...
class AddQuestion extends React.Component {
    ...
    addNewQuestion(e){
        ...
        QuestionAction.addQuestion({image: image, answer: answer, type: type, answerA: answerA, a_id: a_id, answerB: answerB,
    ...
    render() {
        ...
        return (
            <DocumentTitle title={'Add Question | Dictionary'}>
                    ...
                    <div className="container">
                        <div className="row">
                            ...
                            <div className="col-md-12 table-responsive">
                                <form className="form-horizontal" encType="multipart/form-data" onSubmit={this.addNewQuestion.bind(this)}>
